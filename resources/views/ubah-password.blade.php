            ...
            <div class="card-body">
                ...
                <form action="{{ route('editPassword.store') }}" method="POST">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input class="form-control" type="password" id="oldPass" name="oldPass" placeholder="oldPass"
                            value="">
                        <span class="input-group-text">
                            <i class="fa fa-eye" id="toggleoldPass" style="cursor: pointer">
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor"
                                    id="svg-eye" class="bi bi-eye" viewBox="0 0 16 16">
                                    <path
